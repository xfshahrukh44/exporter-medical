                                ...
                                <div class="inputfields row">
                                    ...
                                    <div id="addressdiv" style="display: none">
                                        ...
                                        <div class="select-style col-md-12  mb-35 input-style">
                                            <label>Country *</label>
                                            <input type="text" name="country" id="country" class="billing-address" value="DE" > <!-- readonly --> 
                                        ...
                                        <div class="billing-info col-md-12 input-style ">
                                            ...
                                            <input class="billing-address" type="text" id="address" name="address_line_1" value="Werrastrasse 13" required>  <!-- readonly --> 
                                        </div>

                                        <div class="billing-info col-md-12 input-style">
                                            <label>City *</label>
                                            <input class="billing-address" type="text" id="city" name="city" value="Bad Sooden-Allendorf" required>  <!-- readonly --> 
                                        </div>
                                        <div class="billing-info col-md-12 input-style">
                                            <label>Postal Code *</label>
                                            <input class="billing-address"  type="text" id="postal" name="postal_code" value="37242" required>  <!-- readonly --> 
                                        </div>
                                        <div class="billing-info col-md-12 input-style">
                                            <label>State Code *</label>
                                            <input class="billing-address" type="text" id="state" name="state" value="HE" required>  <!-- readonly --> 
                                        </div>
                                    ...
                                    <div id="shippingdiv" class="grand-total-wrap mb-40 shippingdiv" style="display:none">
                                        ...
                                        <div class="grand-total">
                                            <h4 class="text-right">Total <span
                                                    id="grandtotal">${{ $subtotal + $shipping['totalshipingamount'] }}</span></h4>
                                        </div>
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-md-12 text-center">
                                                    <button type="button" onclick="Auth()" class="mt-40" id="authbtn">Pay
                                                        Now
                                                        ${{ $subtotal }}
                                                    </button>
                                                </div>
        ...
        <script>
            ...
            function initialize() {
                ...
                google.maps.event.addListener(autocomplete, 'place_changed', function() {
                        ...
                        console.log(place);
                        var searchAddressComponents = place.address_components, searchPostalCode="", searchAddress = "", searchCity = "", searchState = "", searchCountryName = "", searchCountryCode = "";
