...
<link rel="stylesheet" href="{{ asset('new/css/intTelInput.css') }}">
<link rel="stylesheet" href="{{ asset('new/css/isValidNumber.css') }}">
<style>
    .hotline p {
        color: #ffffff;
        font-size: 12px;
    ...
    .thirdparty-header-action-icon-2 {
        width: 4em;
    }



    .thirdparty-header-action-icon-2 img {
        margin-right: 0 !important;
    }

    .thirdparty-header-action-icon-2 a {
        width: 100% !important;
    }
</style>
<style>
