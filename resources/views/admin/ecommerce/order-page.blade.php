    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12">
		...
		@foreach($order_products as $order_product)
            ...
            <td> <img src="{{asset($product->image)}}" alt="" title="" style="height: 200px; width: 200px; border-radius: 15px;" > </td>
            ...
            <div class="product-table text-dark no-border">
              <table class="table m-b-5 m-t-20 ">
                ...
                <tr>
                    ...
                    <td class="text-color">{{$order->track_id}}</td>
                </tr>
                <tr>
                    <td class="text-muted">Ship By: </td>
                    <td class="text-color">{{$order->serviceType}}</td>
                </tr>
                <tr>
                    <td class="text-muted">Shipping Amount: </td>
                    <td class="text-color">${{$order->order_shipping}}</td>
                </tr>
                 ...
                 <tr>
                  ...
                  @if($order->is_shipped == 0)
                      <tr>
                        <td class="text-muted">Select Pickup Type: </td>
                        <td class="text-color">{{$order->delivery_address_1}},{{$order->delivery_country}} {{$order->delivery_city}}, {{$order->delivery_state}}</td>
                      </tr>
                  @endif
